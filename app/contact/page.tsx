...
import { COMPANY_NAME, PHONES, REGION_SUMMARY } from '@/lib/config'
...
export const metadata: Metadata = {
  ...
  description:
    `Get in touch with ${COMPANY_NAME} — call us toll-free at ${PHONES.tollFree.display}, or send a message online. We serve ${REGION_SUMMARY}.`,
  alternates: {
    canonical: '/contact',
  },
}
  ...
  return (
    <>
      ...
      <main>
        ...
        {/* Map embed */}
        <section className="bg-gray px-6 pb-20">
          <div className="max-w-6xl mx-auto">
            <h3 className="text-xl font-bold text-navy mb-5 text-center" style={{ fontFamily: 'var(--font-playfair)' }}>
              Our Service Area
            </h3>
            <div className="rounded-2xl overflow-hidden border-2 border-border h-72">
              <iframe
