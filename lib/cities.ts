...
export const cities: CityData[] = [
  ...
  },
  {
    ...
    county: 'Ventura County',
    phone: '(805) 991-7400',
    heroDesc: 'Reliable water delivery for Fillmore and Piru area homes and businesses — clean, pure water on your schedule.',
    neighborhoods: ['Downtown Fillmore', 'Fillmore Heights', 'Bardsdale', 'Piru', 'Sespe'],
  ...
  },
  {
    ...
    county: 'Ventura County',
    phone: '(805) 991-7400',
    heroDesc: 'Reliable water delivery for Santa Paula homes and businesses — pure, great-tasting water delivered on your schedule.',
    neighborhoods: ['Downtown Santa Paula', 'East Santa Paula', 'West Santa Paula', 'Limoneira', 'Faulkner Farm'],
    zips: ['93060','93061'],
    customerTypes: ['Homes & Families', 'Agricultural Businesses', 'Offices', 'Restaurants'],
    testimonial: {
